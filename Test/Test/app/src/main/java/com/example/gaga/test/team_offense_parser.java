...
public class team_offense_parser extends AsyncTask<Void,Integer,Integer> {
    ...
    public team_offense_parser(Context c, String data, ListView lv) {
        this.c = c;
        this.data = data;
        this.lv = lv;
    }
    ...
    protected void onPostExecute(Integer integer) {
        ...
        if(integer == 1)
        {
            ...
            SimpleAdapter adapter = new SimpleAdapter(c,
                    ...
                    new String[]{"name","year","team","G","WHIP","ERA","NP"},
    ...
    private int parse()
    {
        try
        {
            ...
            for(int i=0;i<ja.length();i++)
            {
                ...
                String WHIP=jo.getString("WHIP");
                String ERA=jo.getString("ERA");
                String NP=jo.getString("NP");
                item.put("name",name);
                item.put("year",year);
                item.put("team",team);
                item.put("G",G);
