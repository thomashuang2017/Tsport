...
public class fuban_defense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv6.setText("PO");
        tv7.setText("A");
        String url= "http://163.13.201.116/baller_defense_fuban.php";
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        if(keyCode == KeyEvent.KEYCODE_BACK){
            ...
            myIntent = new Intent(fuban_defense.this, Baseball_warrior.class);
