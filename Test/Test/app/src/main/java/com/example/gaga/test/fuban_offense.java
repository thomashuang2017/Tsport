...
public class fuban_offense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv6.setText("ERA/OBP");
        tv7.setText("NP/AVG");
        String url= "http://163.13.201.116/baller_offense_fuban.php";
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        if(keyCode == KeyEvent.KEYCODE_BACK){
            ...
            myIntent = new Intent(fuban_offense.this, Baseball_warrior.class);
